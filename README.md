...
- `acm-backend-lsp-match-mode`: The filtering mode for candidates in LSP backend, there are six options: "prefix", "prefixCaseSensitive", "exact", "regex", "regex-prefix" and "fuzzy". By default it is "fuzzy"
