...
2. Install Python dependencies: `pip3 install epc orjson six` (orjson is optional, orjson is based on Rust, providing faster JSON parsing performance)
...
| [vscode-html-language-server](https://github.com/hrsh7th/vscode-langservers-extracted)               | Html                                    |                                                                                                                                                                                           |
| [vscode-css-language-server](https://github.com/hrsh7th/vscode-langservers-extracted)                | Css                                     |                                                                                                                                                                                           |
