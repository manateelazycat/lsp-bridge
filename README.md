...
## Usage
lsp-bridge is design for out the box. After [installing the LSP server command](https://github.com/manateelazycat/lsp-bridge#supported-language-servers) corresponding to the open file, you can write the code directly without additional settings.
