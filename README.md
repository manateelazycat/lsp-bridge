...
| 41    | [omnisharp-mono](https://github.com/OmniSharp/omnisharp-roslyn)                                         | c#                              | OmniSharp is a .NET development platform based on Roslyn workspaces. use `M-x lsp-bridge-install-omnisharp` to install it. `lsp-bridge-csharp-lsp-server` set to `omnisharp-mono`                                                              |
| 42    | [omnisharp-dotnet](https://github.com/OmniSharp/omnisharp-roslyn)                                         | c#                              | OmniSharp is a .NET development platform based on Roslyn workspaces. use `M-x lsp-bridge-install-omnisharp` to install it. `lsp-bridge-csharp-lsp-server` set to `omnisharp-dotnet` (6.0)                                                              |
| 43    | [deno](https://deno.land)                                                                          | Deno                            | Deno runtime use TypeScript as source code, you need customize option `lsp-bridge-get-single-lang-server-by-project` that return result "deno" when `project-path` match Deno project. |
| 44    | [Phpactor](https://github.com/phpactor/phpactor)                                                   | php                             | lsp-brige-php-lsp-server set to `phpactor`                                                                                                                                             |
| 45    | [pylsp](https://github.com/python-lsp/python-lsp-server)                                           | python                          | `lsp-bridge-python-lsp-server` set to `pylsp`                                                                                                                                                   |
