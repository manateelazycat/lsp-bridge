...
5. Please do not enable ```native compilation``` on lsp-bridge, as native compilation may affect the startup of lsp-bridge
...
| [lexical](https://github.com/elixir-tools/next-ls)                                                 | Elixir                                  |                                                                                                                                                                                                                                                                    |
...
| [Phpactor](https://github.com/phpactor/phpactor)                                                   | PHP                                     | lsp-bridge-php-lsp-server set to `phpactor`                                                                                                                                                                                                                         |
