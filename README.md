...
- `lsp-bridge-python-multi-lsp-server`: Python multi-language servers, you can choose `basedpyright_ruff`, `pyright_ruff`, `pyright-background-analysis_ruff`, `jedi_ruff`, `python-ms_ruff`, `pylsp_ruff`, `ty_ruff`
- `lsp-bridge-r-multi-lsp-server`: R multi-language servers, you can choose `rlanguageserver_air`
- `lsp-bridge-javascript-lsp-server`: JavaScript language server, you can choose `javascript` (typescript-language-server), `javascript-go` (tsgo --lsp) or `javascript-deno`
- `lsp-bridge-javascript-react-lsp-server`: .jsx language server, you can choose `javascriptreact` (typescript-language-server), `javascript-go-react` (tsgo --lsp) or `javascript-deno-react`
- `lsp-bridge-typescript-lsp-server`: TypeScript language server, you can choose `typescript` (typescript-language-server), `typescript-go` (tsgo --lsp) or `typescript-deno`
- `lsp-bridge-typescript-react-lsp-server`: .tsx language server, you can choose `typescriptreact` (typescript-language-server), `typescript-go-react` (tsgo --lsp) or `typescript-deno-react`
...
| Deno        | [deno](https://deno.land)                                                                          | Deno runtime use TypeScript as source code, you need customize option `lsp-bridge-get-single-lang-server-by-project` that return result "deno" when project-path match Deno project. Or set it in `lsp-bridge-typescript-lsp-server` and `lsp-bridge-typescript-react-lsp-server`.                                                                              |
...
|             | [elixirLS](https://github.com/elixir-lsp/elixir-ls)                                                | Please ensure that the `elixir-ls` release directory is in your system PATH at first                                                                                                                                                                                |
...
|             | [vscode-eslint-language-server](https://github.com/microsoft/vscode-eslint)                         | Used by `typescript_eslint` and `typescriptreact_eslint` multi-language server definitions                                                                                                                                                                          |
...
|             | [marksman](https://github.com/artempyanykh/marksman)                                               | `lsp-bridge-markdown-lsp-server` set to `marksman`                                                                                                                                                                                                                  |
...
| PowerShell  | [PowerShell Editor Services](https://github.com/PowerShell/PowerShellEditorServices)                | Install `powershell-mode`, `pwsh`, and a PowerShell Editor Services release. Set `LSP_BRIDGE_POWERSHELL_EDITOR_SERVICES_DIR` to the extracted release root, `LSP_BRIDGE_POWERSHELL_LOG_PATH` to a writable log directory, and `LSP_BRIDGE_POWERSHELL_SESSION_DETAILS_PATH` to a writable session-details file. |
...
|             | [pyright](https://github.com/microsoft/pyright)                                                    | `lsp-bridge-python-lsp-server` set to `pyright`                                                                                                                                                                                                                      |
|             | [pyright-background-analysis](https://github.com/microsoft/pyright)                                | `lsp-bridge-python-lsp-server` set to `pyright-background-analysis`; it is faster sometimes, but it can’t return diagnostics                                                                                                                                          |
...
|             | [air](https://github.com/posit-dev/air)                                                            | `lsp-bridge-r-lsp-server` set to `air`, or use `rlanguageserver_air` for the combined setup                                                                                                                                                                          |
...
| Slint       | [slint-lsp](https://docs.slint.dev/latest/docs/slint/guide/tooling/manual-setup/)                 | `cargo install slint-lsp`, or download a pre-built binary from the latest Slint release                                                                                                                                                                            |
...
|             | [vtsls](https://github.com/yioneko/vtsls)                                                          | `npm install -g @vtsls/language-server`, used by `volar_vtsls`                                                                                                                                                                                                        |
|             | [typescript-go](https://github.com/microsoft/typescript-go) |                                                                                                                                                                                                                               |
