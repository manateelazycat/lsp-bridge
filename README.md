...
| 41    | [omnisharp](https://github.com/OmniSharp/omnisharp-roslyn)                                         | c#                              | OmniSharp is a .NET development platform based on Roslyn workspaces. use `M-x lsp-bridge-install-omnisharp` to install it. Set to `omnisharp-mono`. Set `lsp-bridge-csharp-lsp-server` to choose between `omnisharp-mono` and `omnisharp-dotnet` (6.0)                                                              |
