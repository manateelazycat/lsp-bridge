...
|             | [csharp-ls](https://github.com/razzmatazz/csharp-language-server)                                    | 用命令 `dotnet tool install -g csharp-ls` 来安装 `csharp-ls`, `lsp-bridge-csharp-lsp-server` 设置成 `csharp-ls`                                                                                   |
